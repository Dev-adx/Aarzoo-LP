...
const LearningSection = () => {
  const points = [
    ...
    "The 'Save & Pray' Method is Dead. Inflation is currently eroding your purchasing power faster than your savings account can grow",
    ...
    "Eliminate 'Investor’s Anxiety.' Stop second-guessing and start following a data-backed plan",
