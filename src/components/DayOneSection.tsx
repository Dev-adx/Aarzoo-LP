...
const STEP1: Step = {
  icon: Goal,
  title: "Step 1: The Wealth Gap Analysis",
  intro:
    "Use our proprietary Financial Goal Calculator to find the exact gap between where you are and your 'Financial Freedom' number.",
      ...
      <section className="relative overflow-hidden" style={{ backgroundColor: COLORS.navy }}>
        <div className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16 text-center">
          ...
          >
            ...
            >
              Day 1: <span style={{ color: COLORS.yellow }}>Financial Defense</span>.{" "}
              <span style={{ color: COLORS.orange }}>Stop the Leaks & Build Your Shield.</span>
            </motion.h2>
