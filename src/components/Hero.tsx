        ...
        >
          ...
          >
            <motion.span variants={line} className="block">
              Stop Guessing <br />
              <span style={{ color: COLORS.redOrange }}>Your Way to Wealth.</span>
            </motion.span>
          </h1>
          ...
          >
            <motion.span variants={line} className="block">
              Build a <span style={{ color: COLORS.orange }}>Bulletproof Financial Roadmap</span>
            </motion.span>
            <motion.span variants={line} className="block">
          ...
          >
            ...
            to master the Structured Diversification Framework 
            used by the top 1% to grow wealth—without chasing 'tips,' 
            hype, or fake guarantees.
          </motion.p>
            ...
            <form onSubmit={onSubmit} className="space-y-5" id="register">
              ...
              <button
                ...
                className="w-full h-12 rounded-2xl font-extrabold text-black 
                           ...
                           style={{ background: `linear-gradient(90deg, ${COLORS.yellow}, ${COLORS.orange})` }}
              >
                {submitting ? "Submitting..." : "Join My Masterclass for ₹99"}
              </button>
            </form>
          </div>
        </motion.div>
