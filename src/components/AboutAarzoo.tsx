      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 py-12 md:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)] md:px-6 md:py-16">
        ...
        >
          ...
          <motion.p variants={fadeUp(0.1)} className="mt-6 text-base leading-7 text-neutral-800 md:text-lg">
           Aarzoo Shah: SEBI Registered Analyst (INH000022297). I bridge the gap between high-level financial strategy and real-world execution. Having mentored 2,000+ professionals, I don't just teach 'finance'—I teach you how to build a self-sustaining wealth machine.
          </motion.p>
