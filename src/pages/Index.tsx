     ...
     <Suspense fallback={Fallback}><SpeakerGallery /></Suspense>
      ...
      <Suspense fallback={Fallback}>
        <AudienceFitSection cards={[
          ...
          { image: img3, caption: "Working professionals  who are tired of 'surface-level' advice and want a professional-grade system to manage their hard-earned capital." },
        ]}/>
      </Suspense>
